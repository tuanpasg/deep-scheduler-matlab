function info = nrDLPMISubbandInfo(carrier,reportConfig)
% nrDLPMISubbandInfo Downlink PMI subband information
%   INFO = nrDLPMISubbandInfo(CARRIER,REPORTCONFIG) returns the PMI subband
