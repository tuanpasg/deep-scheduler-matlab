%   [sinrBand, subbandIndices] = nrSINRPerSubband(SINR, BANDSIZE) returns
...
%
%   See also hPMISelect, hPMISelectionSINRLoss.

%   Copyright 2019-2023 The MathWorks, Inc.

function [sinrSubband, subbandIndices] = nrSINRPerSubband(sinr, bandSize)
    ...
    for s = 1:numSubbands
        ...
        denom = sum(sum(sinrs,3)~=0,[1 2]);
        if(denom==0)
           denom = 1;
        end
        sinrSubband(s,:) = squeeze(sum(sinrs,[1 2])/denom)';
    end
end